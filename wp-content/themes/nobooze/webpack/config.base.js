...
module.exports = (projectOptions) => {
     ...
     */
    const oldRules = {
        test: projectOptions.projectOld.rules.test,
        use: [
            {
                loader: 'file-loader',// Or `url-loader` or your other loader
                options: {
    ...
    return {
        cssRules: cssRules, jsRules: jsRules, imageRules: imageRules, fontsRules: fontsRules, oldRules: oldRules, optimizations: optimizations, plugins: plugins
    }
}