...
<section class="article-banner p-relative d-flex d-flex-column d-flex-align-c d-flex-justify-c">
    ...
    <div class="article-banner__bg p-absolute w-100 h-100">
        <div class="jarallax jarallax-down article-banner__image w-100 h-100">
            <img class="jarallax-img article-banner__img" src="<?php the_post_thumbnail_url(); ?>" alt="<?= get_post_meta( get_post_thumbnail_id(), '_wp_attachment_image_alt', true ); ?>" />
        </div>
    </div>
    <?php endif; ?>
