...
<section class="article-banner p-relative d-flex d-flex-column d-flex-align-c d-flex-justify-c">
    <div class="article-banner__container d-flex wrapper-large w-100 p-relative">
    ...
    <div class="article-banner__bg d-flex d-flex-align-e">
        <img src="<?= get_template_directory_uri() ?>/assets/src/images/Alcohol-Coach-Blog.jpeg" alt="article banner image" class="article-banner__img d-block">
    </div>
</section> 