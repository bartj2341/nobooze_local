...
<?php if (@file_exists(dirname( __FILE__ ).'/../../../wp-includes/js/jquery/ui/'.$prefix_ui.'position.min.js')) { ?><script type='text/javascript' src='<?php echo $plugin_url.'/../../../wp-includes/js/jquery/ui/'.$prefix_ui.'position.min.js'; ?>'></script><?php } ?>
    ...
    function insert_button() {
        ...
        print '<a href="javascript:cpappbk_appointments_fpanel.open()" class="cpapphbinsertb" title="'.__('Insert Appointment Hour Booking','appointment-hour-booking').'"><img hspace="5" src="'.plugins_url('/images/cp_form.gif', __FILE__).'" alt="'.__('Insert  Appointment Hour Booking','appointment-hour-booking').'" /></a>';
    }
